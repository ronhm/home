$(document).ready(function() {
    ...
    $('#second-step-button').click(function() {
        ...
        progressBar(0, $('#progressBarConsole'));
        $('.message-header h3').html("Pizza Ready Generator");
        ...
        setTimeout(function() {
            ...
            $(".message-content p.console-message").typed({
                strings: ["<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Money Added Successfully"],
                showCursor: false,
                typeSpeed: -50,
                onStringTyped: function() {
